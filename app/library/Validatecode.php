...
//  private $fontcolor;//指定字体颜色
 ...
 public function __construct() {
    ...
    $this->charset = Bootstrap::Web_Config()['code_charset'];
 ...
 private function createBg() {
  ...
  $color = imagecolorallocate($this->img,mt_rand(229,229), mt_rand(229,229), mt_rand(229,229));
 ...
 private function createFont() {
  ...
  for ($i=0;$i<$this->codelen;$i++) {
   $this->fontcolor = imagecolorallocate($this->img,mt_rand(75,80),mt_rand(75,80),mt_rand(75,80));
